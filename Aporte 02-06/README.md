...
2. Ejecutar ClienteTCP.
3. Enviar una operación.
4. Detener uno de los nodos, por ejemplo N3.
5. Esperar unos segundos.
6. Verificar en consola que los demás nodos detectan la caída y eligen un nuevo coordinador.
